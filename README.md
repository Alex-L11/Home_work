...
На данный момент работают 13 блоков:
...
#### *13) принимает путь до файла csv и возвращает список словарей с транзакциями*
код блока:
~~~python   
...
#### *14) принимает путь до файла excel и возвращает список словарей с транзакциями*
код блока:
~~~python 
